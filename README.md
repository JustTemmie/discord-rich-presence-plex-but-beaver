...
This script is unmodified from the [original script](https://github.com/phin05/discord-rich-presence-plex) except for the part where i turned the "playing" icon into a beaver :blush:
